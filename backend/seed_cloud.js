...
async function run() {
    ...
    try {
        ...
        allProducts.push(
            ...
            { category: 'cpu', brand: 'INTEL', name: 'CPU Intel Core i5-13400F (Up to 4.6GHz, 10 Nhân 16 Luồng, 20MB Cache, Socket LGA 1700)', stock: 50, price: 5290000, attributes: { category: 'cpu', brand: 'INTEL', socket: 'LGA 1700', cores: 10, threads: 16, baseClock: '2.5 GHz', boostClock: '4.6 GHz' } },
            { category: 'cpu', brand: 'INTEL', name: 'CPU Intel Core i3-12100F (Up to 4.3GHz, 4 Nhân 8 Luồng, 12MB Cache, Socket LGA 1700)', stock: 45, price: 2190000, attributes: { category: 'cpu', brand: 'INTEL', socket: 'LGA 1700', cores: 4, threads: 8, baseClock: '3.3 GHz', boostClock: '4.3 GHz' } },
            { category: 'cpu', brand: 'AMD', name: 'CPU AMD Ryzen 9 7950X3D (Up to 5.7GHz, 16 Nhân 32 Luồng, 144MB Cache, Socket AM5)', stock: 15, price: 17590000, attributes: { category: 'cpu', brand: 'AMD', socket: 'AM5', cores: 16, threads: 32, baseClock: '4.2 GHz', boostClock: '5.7 GHz' } },
            { category: 'cpu', brand: 'AMD', name: 'CPU AMD Ryzen 7 7800X3D (Up to 5.0GHz, 8 Nhân 16 Luồng, 96MB Cache, Socket AM5)', stock: 30, price: 10490000, attributes: { category: 'cpu', brand: 'AMD', socket: 'AM5', cores: 8, threads: 16, baseClock: '4.2 GHz', boostClock: '5.0 GHz' } },
            { category: 'cpu', brand: 'AMD', name: 'CPU AMD Ryzen 5 7600X (Up to 5.3GHz, 6 Nhân 12 Luồng, 32MB Cache, Socket AM5)', stock: 40, price: 6190000, attributes: { category: 'cpu', brand: 'AMD', socket: 'AM5', cores: 6, threads: 12, baseClock: '4.7 GHz', boostClock: '5.3 GHz' } },
        ...
        allProducts.push(
            ...
            { category: 'vga', brand: 'NVIDIA', name: 'VGA MSI GeForce RTX 4060 Ti VENTUS 2X BLACK 8GB OC', stock: 40, price: 11490000, attributes: { category: 'vga', brand: 'NVIDIA', vram: '8GB GDDR6', cudaCores: 4352, boostClock: '2580 MHz', memoryInterface: '128-bit', tdp: '160W' } },
            { category: 'vga', brand: 'NVIDIA', name: 'VGA ASUS Dual GeForce RTX 4060 OC Edition 8GB GDDR6', stock: 55, price: 8490000, attributes: { category: 'vga', brand: 'NVIDIA', vram: '8GB GDDR6', cudaCores: 3072, boostClock: '2505 MHz', memoryInterface: '128-bit', tdp: '115W' } },
            { category: 'vga', brand: 'AMD', name: 'VGA Sapphire PULSE AMD Radeon RX 7900 XTX 24GB GDDR6', stock: 12, price: 28990000, attributes: { category: 'vga', brand: 'AMD', vram: '24GB GDDR6', boostClock: '2525 MHz', memoryInterface: '384-bit', tdp: '355W' } },
        ...
        allProducts.push(
            ...
            { category: 'ram', brand: 'KINGSTON', name: 'RAM Kingston Fury Beast DDR4 16GB (2x8GB) 3200MHz CL16', stock: 50, price: 1090000, attributes: { category: 'ram', brand: 'KINGSTON', ramType: 'DDR4', capacity: '16GB (2x8GB)', busSpeed: '3200MHz', casLatency: 'CL16' } },
        ...
        console.error('\n❌ LỖI:', e);
        if (e && e.message && (e.message.includes('ECONNREFUSED') || e.message.includes('ETIMEDOUT'))) {
